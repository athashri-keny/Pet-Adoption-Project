...
FetchPost()
  ...
  return (
      <div className='relative w-full sm:-[700px] md:w-[1000px] lg:w-[1351px]  ' >
        <div>
          <img src= {CoverImg} className='object-auto'/>
        </div>
        <div className=' absolute left-0 top-0  mt-47 pl-30 '>
          <h1 className='text-7xl font-rubik pb-5 text-white sm:text-xl md:text-3xl lg:text-7xl'>Ready to Adopt !</h1>
          <p className='font-rubik text-xl text-white pb-10  sm:text-xl  md:text-3xl lg:text-xl'> Find your perfect furry friend. Adopt,<br></br> don’t shop — give a pet a loving home today!</p>
            <Link
            to={'/puppies'}
